    ...
    <div class="container container--cart">
      <div v-if="store.state.cart.length" class="cart">
        <div class="cart__top">
          ...
          <div @click="deleteAllCartItems()" class="cart__clear">
        ...
        <div class="cart__bottom">
          <div class="cart__bottom-details">
            <span> Всего пицц: <b>{{ store.getters.totalSum }} шт.</b> </span>
            <span> Сумма заказа: <b>{{ store.getters.totalPrice }} c</b> </span>
          </div>
